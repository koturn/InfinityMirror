 ...
 */
half4 fragInfinityMirrorForward() : SV_Target
{
 ...
 */
fout_infmirror fragInfinityMirrorForward(v2f_infmirror fi, face_t facing : FACE_SEMANTICS)
#    else
/*!
 * @brief Fragment shader function.
 * @param [in] fi  Input data from vertex shader.
 * @return Color and depth of texel.
 */
fout_infmirror fragInfinityMirrorForward(v2f_infmirror fi)

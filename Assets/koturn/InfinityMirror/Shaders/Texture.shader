Shader "koturn/InfinityMirror/Texture"
{
    Properties
    {
        ...
        _OverClip ("Clip overshooting position", Int) = 1
        ...
        [ToggleOff(_DEPTHOUTPUT_OFF)]
        _DepthOutput ("SV_Depth ouput", Int) = 1
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma shader_feature_local_fragment _ _DEPTHOUTPUT_OFF
            ...
            #pragma fragment fragInfinityMirrorForward
            ENDCG
        }
